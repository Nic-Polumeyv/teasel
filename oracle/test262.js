...
const acorn_wrong = jobs.filter((job, i) => Boolean(expected[i].error) === job.should_pass);
...
process.exit(compare(jobs, expected, actual, { verbose, label: 'test262-parser-tests' }) ? 0 : 1);
