...
<svg viewBox="0 0 720 200" width="100%" role="img" aria-label="the answer is an object with node and end, and with comments, errors, typescript, scopes, bindings and references tables when their option is on" fill="none" stroke="currentColor" stroke-width="1.5" font-size="14" class="my-8">
  ...
  <rect x="24" y="52" width="200" height="124" rx="8"/><text x="124" y="80" text-anchor="middle" fill="currentColor" stroke="none">node</text>
  ...
  <rect x="248" y="52" width="120" height="52" rx="8"/><text x="308" y="83" text-anchor="middle" fill="currentColor" stroke="none">end</text>
  <rect x="392" y="52" width="140" height="36" rx="8"/><text x="462" y="75" text-anchor="middle" fill="currentColor" stroke="none" font-size="13">comments</text>
  <rect x="392" y="96" width="140" height="36" rx="8"/><text x="462" y="119" text-anchor="middle" fill="currentColor" stroke="none" font-size="13">errors</text>
  <rect x="392" y="140" width="140" height="36" rx="8"/><text x="462" y="163" text-anchor="middle" fill="currentColor" stroke="none" font-size="13">typescript</text>
  <rect x="556" y="52" width="140" height="36" rx="8"/><text x="626" y="75" text-anchor="middle" fill="currentColor" stroke="none" font-size="13">scopes</text>
  <rect x="556" y="96" width="140" height="36" rx="8"/><text x="626" y="119" text-anchor="middle" fill="currentColor" stroke="none" font-size="13">bindings</text>
  <rect x="556" y="140" width="140" height="36" rx="8"/><text x="626" y="163" text-anchor="middle" fill="currentColor" stroke="none" font-size="13">references</text>
</svg>
