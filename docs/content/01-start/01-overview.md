...
<svg viewBox="0 0 720 200" width="100%" role="img" aria-label="the source text and the rules of what to read go into the engine, which lexes, parses and analyses scopes in one pass; the decoder turns its answer into an ESTree tree with the scope tables beside it" fill="none" stroke="currentColor" stroke-width="1.5" font-size="14" class="my-8">
  <rect x="8" y="24" width="160" height="56" rx="8" class="fill-sky-400/15 stroke-sky-400/60"/><text x="88" y="57" text-anchor="middle" fill="currentColor" stroke="none">source text</text>
  <rect x="8" y="120" width="160" height="56" rx="8" class="fill-amber-400/15 stroke-amber-400/60"/><text x="88" y="153" text-anchor="middle" fill="currentColor" stroke="none">what to read</text>
  <path d="M168 52 C 200 52, 200 100, 232 100" marker-end="url(#a)"/>
  <path d="M168 148 C 200 148, 200 100, 232 100" marker-end="url(#a)"/>
  <rect x="234" y="60" width="200" height="80" rx="8" class="fill-violet-400/15 stroke-violet-400/60"/><text x="334" y="105" text-anchor="middle" fill="currentColor" stroke="none">engine</text>
  ...
  <rect x="638" y="120" width="74" height="56" rx="8" class="fill-rose-400/15 stroke-rose-400/60"/><text x="675" y="153" text-anchor="middle" fill="currentColor" stroke="none">scopes</text>
